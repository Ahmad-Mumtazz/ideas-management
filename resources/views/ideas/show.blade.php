        ...
        <div class="mt-3 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="flex shrink-0 flex-wrap items-center gap-2">
                ...
                <x-confirm-form
                    ...
                    title="Permanently delete this idea?"
                    :message="'“'.$idea->title.'” and all of its checkpoints, links and uploaded files will be deleted for good. This cannot be undone.'"
                            ...
                            <li x-data="{ editing: false }" class="py-2.5">
                                ...
                                <div x-show="! editing" class="flex items-center gap-3">
                                    ...
                                    <span @class([
                                        ...
                                        'text-slate-400 line-through dark:text-slate-500' => $checkpoint->is_completed,
                ...
                <dl class="space-y-3.5 text-sm">
                    ...
                    <div class="flex items-center justify-between gap-3">
                        ...
                        <dd @class([
                            ...
                            'text-rose-600 dark:text-rose-400' => $idea->isOverdue(),
